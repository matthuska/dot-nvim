" Custom stuff for editing R
" Using 4 spaces instead of tabs, as suggested by:
"
...
" Usage: place cursor on function name and press F3
"
" https://github.com/jiang-hang/vim4roxygen2
function! GetRparams()
    let s:start = line('.')
    let s:end = search("{")
